/*! build package in 2022/10/12 11:48:55 ! */
import{e as O,a as M,b as L,r as S,f as j,h as A,i as B,o as T,j as C,k as d,w as D,v as F,u as b,l as $,t as k,p as z,m as N,c as I}from"./entry-8823e517.mjs";import{u as V,a as P}from"./useState-060be4ea.mjs";var U=()=>O;const u=c=>(z("data-v-e1904caa"),c=c(),N(),c),R={class:"trend"},W=u(()=>d("div",{class:"chart-title"},"Big Model Trend",-1)),Y={style:{position:"relative"}},q=u(()=>d("div",{id:"trend-container",class:"chart-container"},null,-1)),G={class:"watermark"},H=u(()=>d("br",null,null,-1)),J=$(" @OpenBMB "),K=L({__name:"Trend",setup(c){let p,m=S(""),i;const h=V();h.value={loading:!0,isLoadFailed:!1};const x=j(),E=()=>{var _;return fetch(`${(_=x==null?void 0:x.app)==null?void 0:_.baseURL}all_models.json`).then(l=>l.json()).then(l=>{var f;h.value={loading:!1,isLoadFailed:!1},m.value=(f=l==null?void 0:l[0])==null?void 0:f.last_updated,i=l.reduce((e,a,n)=>{var v,y,w;if(n==0)return e;const o=+new Date(a.release_date);let t=new Array;return a.parameters_dense&&(a.parameters_max_dense=Math.max.call(null,...(v=a.parameters_dense)==null?void 0:v.map(s=>Number(s.replace("~","").replace("B",""))))),a.parameters_MoE&&(a.parameters_max_moe=Math.max.call(null,...(y=a.parameters_MoE)==null?void 0:y.map(s=>Number(s.replace("~","").replace("B",""))))),a.domain.includes("Text")&&((w=a.language)==null||w.forEach(s=>{if(["English","Chinese","Multilingual"].includes(s))if(e[`Text (${s})`]||(e[`Text (${s})`]=[]),a.parameters_dense&&a.parameters_MoE)t=[o,Math.log2(a.parameters_max_dense),a.parameters_max_dense,...Object.values(a)],e[`Text (${s})`].push(t),t=new Array,t=[o,Math.log2(a.parameters_max_moe),a.parameters_max_moe,...Object.values(a),"MoE"],e[`Text (${s})`].push(t);else{const r=a.parameters_max_dense||a.parameters_max_moe;t=[o,Math.log2(r),r,...Object.values(a),a.parameters_max_moe?"MoE":""],e[`Text (${s})`].push(t)}else if(e["Text (Others)"]||(e["Text (Others)"]=[]),a.parameters_dense&&a.parameters_MoE)t=[o,Math.log2(a.parameters_max_dense),a.parameters_max_dense,...Object.values(a)],e["Text (Others)"].push(t),t=new Array,t=[o,Math.log2(a.parameters_max_moe),a.parameters_max_moe,...Object.values(a),"MoE"],e["Text (Others)"].push(t);else{const r=a.parameters_max_dense||a.parameters_max_moe;t=[o,Math.log2(r),r,...Object.values(a),a.parameters_max_moe?"MoE":""],e["Text (Others)"].push(t)}})),a.domain.forEach(s=>{if(s!=="Text")if(e[s]||(e[s]=[]),a.parameters_dense&&a.parameters_MoE)t=[o,Math.log2(a.parameters_max_dense),a.parameters_max_dense,...Object.values(a)],e[s].push(t),t=new Array,t=[o,Math.log2(a.parameters_max_moe),a.parameters_max_moe,...Object.values(a),"MoE"],e[s].push(t);else{const r=a.parameters_max_dense||a.parameters_max_moe;t=[o,Math.log2(r),r,...Object.values(a),a.parameters_max_moe?"MoE":""],e[s].push(t)}}),e},{})}).catch(()=>{i=[],h.value={loading:!0,isLoadFailed:!0}})},g={"Text (English)":"#459F48","Text (Chinese)":"#F8B947","Text (Multilingual)":"#2F2EFC","Text (Others)":"#FC832E",Vision:"#953ACE",Audio:"#E63D2A",Code:"#A57041",Protein:"#4BB2EE"};return A(()=>{setTimeout(async()=>{p=U().init(document.getElementById("trend-container")),await E(),console.log(Object.keys(i));let l={tooltip:{show:!0,formatter(e){return`<div style="display:flex;flex-direction:column;row-gap:2px;">
                    <div class="flex-row" >
                    ...
                    <div class="flex-row" >
                      ...
                      ${e.data.at(-1)==="MoE"?Math.ceil(e.data[2]*100)/100+"B (MoE)":Math.ceil(e.data[2]*100)/100+"B"} </span>
                    </div>
